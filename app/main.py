...
from app.api.routes.check_clickbait_api import router as clickbait_router  # Import the clickbait router
...
app.include_router(clickbait_router)  # Register the clickbait router
